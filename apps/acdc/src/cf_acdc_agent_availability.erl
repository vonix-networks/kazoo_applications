...
handle(Data, Call) ->
    ...
    of
        ...
        {'ok', Resp} ->
            branch_on_availability(kz_json:get_integer_value(<<"Agent-Count">>, Resp), Call)
    end,
    'ok'.

-spec branch_on_availability(non_neg_integer(), kapps_call:call()) ->
    {'attempt_resp', 'ok' | {'error', 'empty'}}.
