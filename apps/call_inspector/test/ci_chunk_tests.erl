...
chunks_2('count') ->
    2;
chunks_2('entities') ->
    [<<"10.26.0.182:5060">>, <<"10.26.0.182:11000">>];
chunks_2(1) ->
    {[
...
chunks_5(count) ->
    length(chunks_5());
chunks_5(entities) ->
    [<<"104.237.144.93:5060">>, <<"104.237.144.93:11000">>];
chunks_5(1) ->
    kz_json:from_map(
        #{
            <<"c_seq">> => <<"10 OPTIONS">>,
            ...
            <<"raw">> => [
                <<"OPTIONS sip:104.237.144.93:11000 SIP/2.0">>,
...
chunks_6(count) ->
    length(chunks_6());
chunks_6(entities) ->
    [<<"104.237.144.93:7000">>, <<"104.237.144.93:11000">>];
chunks_6(1) ->
    kz_json:from_map(
        #{
            <<"c_seq">> => <<"2 BYE">>,
            ...
            <<"parser">> => <<"104.237.144.93:9061">>,
            <<"raw">> => [
                <<"BYE sip:7948@104.237.144.93:11000;transport=udp SIP/2.0">>,
...
chunks_7(1) ->
    kz_json:from_map(
        #{
            ...
            <<"parser">> => <<"104.237.144.93:9061">>,
            <<"raw">> => [
                <<"INVITE sip:9990048188880071@104.237.144.93 SIP/2.0">>,
...
chunks_7(4) ->
    kz_json:from_map(
        #{
            ...
            <<"parser">> => <<"104.237.144.93:9061">>,
            <<"raw">> => [
                <<"ACK sip:9990048188880071@104.237.144.93 SIP/2.0">>,
                <<"Via: SIP/2.0/UDP 104.237.144.93;branch=z9hG4bK4f7f.fa988d55e5c136baf2b89b62f1f7a2d0.0">>,
                <<"Max-Forwards: 50">>,
                <<"To: <sip:9990048188880071@104.237.144.93>;tag=KU273F3tNU1rp">>,
                <<"From: <sip:trunk@104.237.144.93>;tag=DVEFCVLI">>,
