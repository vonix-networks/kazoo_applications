...
-define(USER_VM_FLOW_JSON, <<
    "{\"children\":{\"_\": {\"children\": {},\"data\": {\"id\": \"{VM_ID}\"},\"module\": \"voicemail\"}},"
    "\"data\": {\"can_call_self\": false,\"id\": \"{USER_ID}\",\"timeout\": \"20\"},\"module\": \"user\"}"
>>).
-define(USER_VM_METADATA_JSON, <<
    "{\"{VM_ID}\": {\"name\": \"vm1\",\"pvt_type\": \"vmbox\"},"
    "\"{USER_ID}\": {\"name\": \"User Name\",\"pvt_type\": \"user\"}}"
>>).

-define(RING_GROUP_TOGGLE_JSON,
    <<"{\"children\":{},\"data\":{\"action\":\"login\",\"callflow_id\":\"{RING_GROUP_ID}\"},\"module\":\"ring_group_toggle\"}">>
).
-define(RING_GROUP_METADATA_JSON,
    <<"{\"{RING_GROUP_ID}\":{\"name\":\"support ring group\", \"pvt_type\":\"callflow\",\"numbers\":[\"1000\"]}}">>
).
...
metadata_test_gen(FlowJSON, MetadataJSON) ->
    ?_assert(
        kz_json:are_equal(
            get_metadata(kz_json:decode(FlowJSON), <<"db">>),
