...
-define(DEFAULT_STEREO_SAMPLE_RATE,
    kapps_config:get_integer(?APP_NAME, <<"record_stereo_sample_rate">>, 16000)
).

-type fs_app() ::
    {kz_term:ne_binary(), binary() | 'noop'}
...
-record(channel, {
    uuid :: kz_term:api_ne_binary() | '$1' | '$2' | '_',
    ...
    %% is this ecallmgr handling the call control?
    handling_locally = 'false' :: boolean() | '_',
...
-record(conference, {
    name :: kz_term:api_ne_binary() | '$1' | '_',
    uuid :: kz_term:api_ne_binary() | '$1' | '_',
    node :: atom() | '$1' | '$2' | '_',
    participants = 0 :: non_neg_integer() | '_',
    profile_name = <<"default">> :: kz_term:ne_binary() | '_',
    % which participant has the floor
    with_floor :: 'undefined' | non_neg_integer() | '_',
    % which participant has lost the floor
    lost_floor :: 'undefined' | non_neg_integer() | '_',
    ...
    %% was this ecallmgr handling the call control?
    handling_locally = 'false' :: boolean() | '_',
    origin_node :: atom() | '_',
    control_node :: atom() | '_'
}).
...
-define(DEFAULT_REALM,
    kapps_config:get_ne_binary(?APP_NAME, <<"default_realm">>, <<"nodomain.com">>)
).
-define(MAX_TIMEOUT_FOR_NODE_RESTART,
    kapps_config:get_integer(
        ?APP_NAME, <<"max_timeout_for_node_restart">>, 10 * ?MILLISECONDS_IN_SECOND
    )
).
...
-define(FS_SOFIA_TRANSFER_EVENTS, [
    'sofia::transferor',
    'sofia::transferee',
    'sofia::replaced',
    'sofia::intercepted'
...
-define(FS_CONFERENCE_PARTICIPANT, [
    {'id', <<"Participant-ID">>},
    {'uuid', <<"Call-ID">>},
...
-define(CONFERENCE_VARS, [
    <<"variable_conference_moderator">>,
    <<"Floor">>,
    <<"Video">>,
    <<"See">>,
    <<"Speak">>,
...
-define(CONFERENCE_VAR_MAP, [
    {<<"variable_conference_moderator">>, {<<"Is-Moderator">>, fun kz_term:to_boolean/1}},
